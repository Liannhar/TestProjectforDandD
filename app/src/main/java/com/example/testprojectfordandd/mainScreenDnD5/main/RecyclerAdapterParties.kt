...
class RecyclerAdapterParties(private val mas:List<Party>, private val context:MainFragment):RecyclerView.Adapter<ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textViewSecond.text = mas[position].status
